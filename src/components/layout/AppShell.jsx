  ...
  return (
    <div className="flex min-h-screen bg-surface-950">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        {isOwner && (
          <div className="md:hidden flex items-center justify-between px-4 py-4 bg-surface-900/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-30 safe-top">
