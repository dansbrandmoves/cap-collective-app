  ...
  return (
    <div className="max-w-4xl mx-auto px-5 sm:px-8 py-6 sm:py-10">
      ...
      {connectedCalendars.length === 0 ? (
        <p className="text-sm text-zinc-600 mb-6">No calendars connected yet.</p>
      ) : (
      ...
      <div className="space-y-2 mb-4">
        ...
        <Button variant="secondary" size="sm" onClick={resetSlotStateCustomizations} className="mt-2">Reset to Defaults</Button>
      </div>
